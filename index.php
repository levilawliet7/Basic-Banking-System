...
<html lang="en">
  ...
  ?>
            ...
            <div class="row intro py-1">
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                  <h3>Welcome to</h3>
                  <h1>Bank Of Spark</h1>
                  <h2>Bank who cares about its customer. Banking at your finger tip.</h2>
                </div>
              </div>
              <div class="col-sm-12 col-md img text-center">
                <img class="bank-img" src="img/bank.png" class="img-fluid pt-2">
              </div>
            </div>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2022. Made by <b>Gaurav Kumar</b></p>
      </footer>
